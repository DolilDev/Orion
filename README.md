...
[![Pobierz Ørion 0.20.0 beta 27](https://img.shields.io/badge/Pobierz-Ørion%200.20.0%20beta%2027-14b8a6?style=for-the-badge&logo=windows&logoColor=white)](https://github.com/DolilDev/Orion/releases/tag/app-v0.20.0-beta.27)

**[Przejdź do wydania i pobierz instalator dla Windows →](https://github.com/DolilDev/Orion/releases/tag/app-v0.20.0-beta.27)**

> Najnowsza wersja: **0.20.0 beta 27**. Poprzednie i techniczne wydania
> rozszerzeń pozostają dostępne w pełnym [katalogu Releases](https://github.com/DolilDev/Orion/releases).

Beta 27 dodaje w mobilnym Ørionie gest przeciągnięcia w dół, który odświeża dane
i synchronizuje aktywne zadania z komputerem. Przerwane zadanie natychmiast znika
ze stanu oczekiwania, a utracony komunikat kończący nie pozostawia już na stałe
napisu „Przerywam odpowiedź”.
